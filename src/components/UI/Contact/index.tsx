...
export const ContactUI = ({ ContactRef }: { ContactRef: any }) => {
  ...
  return (
    <div id="contact" ref={ContactRef} className="bg-[var(--main)]">
      {/* <h2 className="section-title mt-20 mb-10">our Contacts</h2> */}
      <div className="container">
        <div className="lg:px-20">
          <div className="flex justify-center py-5 md:py-20 items-center md:space-x-20 flex-col md:flex-row sm:px-[22px]">
