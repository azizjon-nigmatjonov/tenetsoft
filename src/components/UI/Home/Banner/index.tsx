    ...
    <div className="container">
      <div className="pt-[150px] md:pt-[190px] pb-[170px] md:pb-[210px] flex items-center md:justify-between flex-col md:flex-row text-center sm:text-left">
        <div>
          ...
          <h1 className="mt-10 sm:mt-20 text-[45px] sm:text-[55px] text-[var(--primary)] font-semibold leading-[60px]">
          ...
          ></h2>
          <div className="mt-10 sm:mt-20 flex space-x-8">
            <button
              className="submit-btn font-medium text-sm sm:text-2xl"
              onClick={() => handleScroll("contact")}
            >
              {t("contact_us")}
            </button>
            <button
              className="default-btn font-medium text-sm sm:text-2xl"
              onClick={() => handleScroll("contact")}
            >
              {t("services")}
            </button>
